let app = {
    ...
    ftw: function(imgURI){
        ...
        if(opsinilai!=null){
            if(opsinilai == "LeAdam"){
                $.ajax({
                    url: "http://192.168.1.5:5000//LeNet-Adam",
                    type: "POST",
                    datatype: "json",
                    crossDomain: true,
                ...
                $.ajax({
                    url: "http://192.168.1.5:5000//LeNet-Nadam",
                    type: "POST",
                    datatype: "json",
                    crossDomain: true,
                    data: JSON.stringify({ imgBs64:imgURI }),
                ...
                $.ajax({
                    url: "http://192.168.1.5:5000//LeNet-SGD",
                    type: "POST",
                    datatype: "json",
                    crossDomain: true,
                    data: JSON.stringify({ imgBs64:imgURI }),
                ...
                $.ajax({
                    url: "http://192.168.1.5:5000//AlexNet-Adam",
                    type: "POST",
                    datatype: "json",
                    crossDomain: true,
                    data: JSON.stringify({ imgBs64:imgURI }),
                ...
                $.ajax({
                    url: "http://192.168.1.5:5000//AlexNet-Nadam",
                    type: "POST",
                    datatype: "json",
                    crossDomain: true,
                    data: JSON.stringify({ imgBs64:imgURI }),
                ...
                $.ajax({
                    url: "http://192.168.1.5:5000//AlexNet-SGD",
                    type: "POST",
                    datatype: "json",
                    crossDomain: true,
                    data: JSON.stringify({ imgBs64:imgURI }),
                ...
                $.ajax({
                    url: "http://192.168.1.5:5000//MiniVgg-Adam",
                    type: "POST",
                    datatype: "json",
                    crossDomain: true,
                    data: JSON.stringify({ imgBs64:imgURI }),
                ...
                $.ajax({
                    url: "http://192.168.1.5:5000//MiniVgg-Nadam",
                    type: "POST",
                    datatype: "json",
                    crossDomain: true,
                    data: JSON.stringify({ imgBs64:imgURI }),
                ...
                $.ajax({
                    url: "http://192.168.1.5:5000//MiniVgg-SGD",
                    type: "POST",
                    datatype: "json",
                    crossDomain: true,
                    data: JSON.stringify({ imgBs64:imgURI }),
